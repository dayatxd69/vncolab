...
def _setupSSHDImpl(ngrok_token, ngrok_region, is_VNC):
  ...
  root_password = "locknjeg"
  user_password = "locknjeg"
  user_name = "colab"
  msg += "✂️"*24 + "\n"
...
def _setupSSHDMain(ngrok_region, check_gpu_available, is_VNC):
  ...
  ngrok_token = "1hBlsVFjmn3POmwxUfwMuyknPRE_41STvPdJ1fsCkQxueq7mf" #@param {type:"string"}  
  ngrok_region = "ap" #@param {type:"string"}  
  clear_output()
  apps()
...
def _setupVNC():
  ...
  libjpeg_url = "https://github.com/dayatxd69/vncolab/blob/main/libjpeg-turbo-official_2.0.6_amd64.deb".format(libjpeg_ver)
  virtualGL_url = "https://github.com/dayatxd69/vncolab/blob/main/virtualgl_2.6.5_amd64.deb".format(virtualGL_ver)
  turboVNC_url = "https://github.com/dayatxd69/vncolab/blob/main/turbovnc_2.2.6_amd64.deb".format(turboVNC_ver)
